...
// Helper function to get meta description for a tool
export function getToolMetaDescription(toolId: string): string {
  const seoData = toolSEO[toolId];
  if (!seoData) {
    console.warn(`No SEO data found for tool: ${toolId}`);
    return 'Professional development tool for web developers and power users';
  }
  return seoData.metaDescription;
}

// Helper function to get page description for a tool
export function getToolPageDescription(toolId: string): string {
  const seoData = toolSEO[toolId];
  if (!seoData) {
    console.warn(`No SEO data found for tool: ${toolId}`);
    return 'Streamline your workflow with this powerful development tool designed for efficiency and ease of use.';
  }
  return seoData.pageDescription;
}
...
export const toolSEO: Record<string, ToolSEO> = {
  'json-validator': {
    ...
    metaDescription:
      'Advanced JSON validator with schema support, real-time error reporting, and security auditing. Perfect for developers and API testing.',
    pageDescription:
  ...
  'text-diff': {
    ...
    metaDescription:
      'Professional text comparison tool with syntax highlighting and side-by-side diff views. Perfect for developers reviewing code changes.',
    pageDescription:
  ...
  'gradient-generator': {
    ...
    metaDescription:
      'Professional CSS gradient generator with linear, radial, and conic gradients. Export to CSS, Tailwind, and SVG. Perfect for web designers.',
    pageDescription:
  ...
  'json-formatter': {
    ...
    metaDescription:
      'Free online JSON formatter and validator. Beautify minified JSON, validate syntax, and debug malformed data instantly in your browser.',
    pageDescription:
  ...
  'base64-encode': {
    ...
    metaDescription:
      'Free Base64 encoder and decoder for text, images, and files up to 50MB. Secure browser-based processing with drag-and-drop interface.',
    pageDescription:
  ...
  'base64-to-pdf': {
    ...
    metaDescription:
      'Convert Base64 encoded data to PDF files with instant download. Secure browser-based conversion with no server uploads.',
    pageDescription:
  ...
  'hash-generator': {
    ...
    metaDescription:
      'Generate MD5, SHA-1, SHA-256, and SHA-512 hash values. Perfect for password hashing and file integrity verification. Browser-based processing.',
    pageDescription:
  ...
  'uuid-generator': {
    ...
    metaDescription:
      'Generate UUID v1 and v4 identifiers for databases, APIs, and applications. Bulk generate up to 1000 UUIDs with customizable formatting.',
    pageDescription:
  ...
  'password-generator': {
    ...
    metaDescription:
      'Generate strong, secure passwords with customizable length (4-128 chars) and character sets. Real-time strength indicator included.',
    pageDescription:
  ...
  'regex-tester': {
    ...
    metaDescription:
      'Test regular expressions with real-time matching and highlighting. Debug regex patterns with live feedback and capture group details.',
    pageDescription:
  ...
  'favicon-generator': {
    ...
    metaDescription:
      'Create professional favicons from any image. Generate all sizes (16x16 to 512x512) in ICO, PNG, and SVG formats with HTML code.',
    pageDescription:
  ...
  'csv-to-json': {
    ...
    metaDescription:
      'Transform CSV files to JSON format with automatic header detection and custom delimiter support. Free, secure browser-based conversion.',
    pageDescription:
  ...
  'crontab-builder': {
    ...
    metaDescription:
      'Create and validate cron expressions using visual builder with dropdown menus and presets. Parse crontab entries with human-readable descriptions.',
    pageDescription:
  ...
  'xml-formatter': {
    ...
    metaDescription:
      'Professional XML formatter with syntax validation, beautification, and minification. Features XPath search and namespace analysis.',
    pageDescription:
  ...
  'jwt-decoder': {
    ...
    metaDescription:
      'Professional JWT decoder with claims analysis, security validation, and expiration checking. Debug authentication issues and analyze token claims.',
    pageDescription:
  ...
  'url-encode': {
    ...
    metaDescription:
      'URL encode and decode components and query parameters for web development. Handle special characters and international text safely.',
    pageDescription:
  ...
  'timestamp-converter': {
    ...
    metaDescription:
      'Convert Unix timestamps to readable dates and vice versa with timezone support. Handle epoch time, milliseconds, and various date formats.',
    pageDescription:
  ...
  'sql-formatter': {
    ...
    metaDescription:
      'Format and beautify SQL queries with proper indentation and keyword highlighting. Supports MySQL, PostgreSQL, and SQLite dialects.',
    pageDescription:
  ...
  'qr-generator': {
    ...
    metaDescription:
      'Professional QR code generator with logo embedding, WiFi/vCard creation, and batch processing. Features SVG export and API integration.',
    pageDescription:
  ...
  'color-picker': {
    ...
    metaDescription:
      'Professional color picker with HEX, RGB, HSL formats. Generate palettes, check WCAG contrast ratios, and export to CSS and Tailwind.',
    pageDescription:
  ...
  'json-to-csv': {
    ...
    metaDescription:
      'Free JSON to CSV converter with advanced flattening and column mapping. Transform JSON arrays and nested objects into Excel-compatible CSV files.',
    pageDescription:
  ...
  'list-compare': {
    ...
    metaDescription:
      'Professional list comparison tool with set operations (union, intersection, difference), fuzzy matching, and Venn diagrams. Compare up to 10 lists.',
    pageDescription:
  ...
  'curl-to-code': {
    ...
    metaDescription:
      'Free cURL to code converter for JavaScript, Python, Go, Java, PHP, Ruby, and 15+ languages. Features automatic error handling and type inference.',
    pageDescription:
  ...
  'json-to-typescript': {
    ...
    metaDescription:
      'Advanced JSON to TypeScript converter with smart type inference, optional properties, and nested interface support. Generate production-ready interfaces.',
    pageDescription:
  ...
  'css-minifier': {
    ...
    metaDescription:
      'Professional CSS minifier and beautifier that reduces file size by up to 60%. Features color compression, rule merging, and vendor prefix handling.',
    pageDescription:
  ...
  'js-minifier': {
    ...
    metaDescription:
      'Professional JavaScript minifier and beautifier with ES2024+ support, reducing bundle size by up to 70%. Features dead code elimination and variable renaming.',
    pageDescription:
