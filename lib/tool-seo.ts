...
export const toolSEO: Record<string, ToolSEO> = {
  'json-validator': {
    ...
    metaDescription:
      'Advanced JSON validator with schema support, real-time error reporting, and security auditing. Perfect for developers.',
    pageDescription:
  ...
  'gradient-generator': {
    ...
    metaDescription:
      'Professional CSS gradient generator with linear, radial, and conic gradients. Export to CSS, Tailwind, and SVG.',
    pageDescription:
  ...
  'json-formatter': {
    ...
    metaDescription:
      'Free online JSON formatter and validator. Beautify minified JSON, validate syntax, and debug malformed data instantly.',
    pageDescription:
  ...
  'base64-encode': {
    ...
    metaDescription:
      'Free Base64 encoder and decoder for text, images, and files up to 50MB. Secure browser-based processing.',
    pageDescription:
  ...
  'hash-generator': {
    ...
    metaDescription:
      'Generate MD5, SHA-1, SHA-256, and SHA-512 hash values. Perfect for password hashing and file integrity verification.',
    pageDescription:
  ...
  'uuid-generator': {
    ...
    metaDescription:
      'Generate UUID v1 and v4 identifiers for databases, APIs, and applications. Bulk generate up to 1000 UUIDs.',
    pageDescription:
  ...
  'password-generator': {
    ...
    metaDescription:
      'Generate strong, secure passwords with customizable length (4-128 chars) and character sets. Real-time strength indicator.',
    pageDescription:
  ...
  'regex-tester': {
    ...
    metaDescription:
      'Test regular expressions with real-time matching and highlighting. Debug regex patterns with live feedback.',
    pageDescription:
  ...
  'favicon-generator': {
    ...
    metaDescription:
      'Create professional favicons from any image. Generate all sizes (16x16 to 512x512) in ICO, PNG, and SVG formats.',
    pageDescription:
  ...
  'csv-to-json': {
    ...
    metaDescription:
      'Transform CSV files to JSON format with automatic header detection and custom delimiter support. Free and secure.',
    pageDescription:
  ...
  'crontab-builder': {
    ...
    metaDescription:
      'Create and validate cron expressions using visual builder with dropdown menus and presets. Parse crontab entries.',
    pageDescription:
  ...
  'xml-formatter': {
    ...
    metaDescription:
      'Professional XML formatter with syntax validation, beautification, and minification. Features XPath search.',
    pageDescription:
  ...
  'jwt-decoder': {
    ...
    metaDescription:
      'Professional JWT decoder with claims analysis, security validation, and expiration checking. Debug authentication issues.',
    pageDescription:
  ...
  'url-encode': {
    ...
    metaDescription:
      'URL encode and decode components and query parameters for web development. Handle special characters safely.',
    pageDescription:
  ...
  'timestamp-converter': {
    ...
    metaDescription:
      'Convert Unix timestamps to readable dates and vice versa with timezone support. Handle epoch time and milliseconds.',
    pageDescription:
  ...
  'sql-formatter': {
    ...
    metaDescription:
      'Format and beautify SQL queries with proper indentation and keyword highlighting. Supports MySQL, PostgreSQL, SQLite.',
    pageDescription:
  ...
  'qr-generator': {
    ...
    metaDescription:
      'Professional QR code generator with logo embedding, WiFi/vCard creation, and batch processing. Features SVG export.',
    pageDescription:
  ...
  'color-picker': {
    ...
    metaDescription:
      'Professional color picker with HEX, RGB, HSL formats. Generate palettes, check WCAG contrast ratios.',
    pageDescription:
  ...
  'json-to-csv': {
    ...
    metaDescription:
      'Free JSON to CSV converter with advanced flattening and column mapping. Transform JSON arrays into Excel-compatible CSV.',
    pageDescription:
  ...
  'list-compare': {
    ...
    metaDescription:
      'Professional list comparison tool with set operations (union, intersection, difference) and fuzzy matching. Compare 10 lists.',
    pageDescription:
  ...
  'curl-to-code': {
    ...
    metaDescription:
      'Free cURL to code converter for JavaScript, Python, Go, Java, PHP, Ruby, and 15+ languages. Automatic error handling.',
    pageDescription:
  ...
  'css-minifier': {
    ...
    metaDescription:
      'Professional CSS minifier and beautifier that reduces file size by up to 60%. Features color compression and rule merging.',
    pageDescription:
